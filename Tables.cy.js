describe('Tables check', function(){
    ...
    it.skip('Table count rows and columns', function(){
    ...
    it.skip('Table record from the rows and columns', function(){
        //test to read data from row and total column and put assertions
